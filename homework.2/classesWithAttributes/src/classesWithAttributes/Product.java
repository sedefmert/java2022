...
public class Product {
	...
	public Product() {
		//aynı classda farklı parametreleri kullanmak overloading yani aşırı yükleme demektir.
	}

	
	 
	private int id;	   //public her yerden erişilebilir olduğu anlamına gelir.
	private String name;
